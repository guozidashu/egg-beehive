        ...
        children: [
          {
            path: 'basisBrand',
            name: 'BasisBrand',
            component: () => import('@/subview/setting/basis/brand'),
            meta: {
              title: '品牌',
              // icon: 'home-2-line',
            },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'zfbprogram',
        name: 'Zfbprogram',
        component: () => import('@/subview/platform/zfbprogram/index'),
        meta: {
          title: '支付宝小程序',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'bdprogram',
        name: 'Bdprogram',
        component: () => import('@/subview/platform/bdprogram/index'),
        meta: {
          title: '百度小程序',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'ttprogram',
        name: 'Ttprogram',
        component: () => import('@/subview/platform/ttprogram/index'),
        meta: {
          title: '头条小程序',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'qqprogram',
        name: 'Qqprogram',
        component: () => import('@/subview/platform/qqprogram/index'),
        meta: {
          title: 'QQ小程序',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'phoneh5',
        name: 'Phoneh5',
        component: () => import('@/subview/platform/phoneh5/index'),
        meta: {
          title: '手机h5',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'phoneapp',
        name: 'Phoneapp',
        component: () => import('@/subview/platform/phoneapp/index'),
        meta: {
          title: '手机app',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'baison',
        name: 'Baison',
        component: () => import('@/subview/platform/baison'),
        meta: {
          title: '百胜ERP',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'burgeon',
        name: 'Burgeon',
        component: () => import('@/subview/platform/burgeon'),
        meta: {
          title: '伯俊BOS',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'pursun',
        name: 'Pursun',
        component: () => import('@/subview/platform/pursun'),
        meta: {
          title: '紫日ERP',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'jushuitan',
        name: 'Jushuitan',
        component: () => import('@/subview/platform/jushuitan'),
        meta: {
          title: '聚水潭ERP',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'pinduoduoktt',
        name: 'Pinduoduoktt',
        component: () => import('@/subview/platform/pinduoduoktt'),
        meta: {
          title: '快团团',
          // icon: 'home-2-line',
        },
      ...
      // 百盛ERP 伯俊BOS 紫日ERP 聚水潭ERP 快团团 抖店开放平台
      //baison burgeon pursun jushuitan pinduoduoktt doudin
    ],
  },
]
/* export const asyncRoutes = [
