    ...
    <el-form label-width="108px">
        ...
        <el-col :span="8">
          ...
          >
            <el-checkbox-group v-model="checked">
              ...
              <el-checkbox label="商品详情页" />
            </el-checkbox-group>
          </el-form-item>
        </el-col>
        <el-col :span="16">
          <span style="line-height: 70px; color: #999999">仅公众号端有效</span>
        </el-col>
      </el-row>
      <el-row type="flex">
        <el-col :span="8">
          <el-form-item label="关注提示：" style="margin-right: 20px">
            <el-checkbox-group v-model="checked1">
              <el-checkbox label="首页" />
              <el-checkbox label="订单播报" />
            </el-checkbox-group>
          </el-form-item>
        </el-col>
        <el-col :span="16">
          <span style="line-height: 0px; color: #999999">
            首页或商品详情页滚动显示最近购买信息
          </span>
        </el-col>
      </el-row>
      ...
      <el-form-item label="进入条件：" style="margin-right: 20px">
        <el-checkbox-group v-model="checked2">
          <el-checkbox label="所有人" />
          <el-checkbox label="普通会员" />
          <el-checkbox label="分销商" />
        </el-checkbox-group>
      </el-form-item>
      <div v-if="checked2.length == 0" style="margin-left: 80px">
        无权限提示:
        <el-input v-model="a" />
      </div>
    </el-form>
