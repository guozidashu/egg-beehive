<template>
  ...
  <div class="image-content">
    ...
    <vuedraggable
      v-if="list.parameters.grid_items && list.parameters.grid_items.length > 0"
    ...
    <template
      v-if="
        list.parameters.grid_items && list.parameters.grid_items.length < len
      "
    >
      <el-button
        class="add-image"
