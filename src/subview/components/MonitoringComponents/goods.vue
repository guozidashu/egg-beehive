  ...
  <div style="width: 100%">
    ...
    <div style="padding: 20px">
        ...
        >
          <div style="display: flex">
            <el-select v-model="form.order" size="small" style="width: 150px">
              ...
              <el-option label="按拿货客户" value="count_customer" />
      ...
      <el-table v-loading="state" :data="tableData">
        ...
        <el-table-column align="center" label="总销量" prop="goods_price" />
        <el-table-column align="center" label="总销售额" prop="sale_num" />
        <el-table-column align="center" label="平均售价" prop="stock" />
        <el-table-column align="center" label="带货客户数" prop="zsc_num" />
        <el-table-column align="center" label="本期销量" prop="stock" />
        <el-table-column align="center" label="本期销售额" prop="zsc_num" />
