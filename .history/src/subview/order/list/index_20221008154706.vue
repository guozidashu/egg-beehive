<template>
  <div class="link-container">
    <ListOptions :order-form="orderForm" @changeSta="changeBtn">
      <template #orderForm>
        <el-row>
          <el-col :span="12">
        ...
        <el-row v-show="!orderForm.fold">
          <el-col :span="8">
            <el-form-item label="配送方式:" prop="region">
              <el-select v-model="orderForm.region">
...
<script>
  ...
  export default {
    name: 'OrderList',
    components: { ListOptions, ListContent },
    data() {
      return {
        orderForm: {
          orderSta: '全部',
