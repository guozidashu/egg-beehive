    ...
    >
      <span slot="footer" class="dialog-footer">
        <el-form label-width="104px" style="margin-top: -60px">
          ...
          <el-form-item label="是否默认" style="margin-left: -30px">
...
<script>
  import { getWaveList, deleteWave, addWave, editWave } from '@/api/basic'
  export default {
    data() {
      return {
        radio: 3,
    ...
    methods: {
      ...
      async openDialog(val) {
        if (val == 'add') {
          ...
          console.log('编辑', val)
           await editWave({ id: val })
          this.formdata={id:val,name:}
        }
