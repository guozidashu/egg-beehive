        ...
        >
          <div>
            ...
            <span style="margin-left: -4px">
              <el-button plain type="success">QY001</el-button>
            </span>
          </div>
          <div>
            <span>颜色：</span>
            <span>
              <el-button style="color: #000" type="text">黑色</el-button>
            </span>
          </div>
          <div>
            <span>尺码：</span>
            <span>
              <el-button plain type="info">80</el-button>
              <el-button plain type="info">90</el-button>
              <el-button plain type="info">100</el-button>
              <el-button plain type="info">110</el-button>
              <el-button plain type="info">120</el-button>
            </span>
          </div>
        </div>
        <div
          style="display: flex; width: 1000px; height: 300px; margin-left: 30px"
        >
          <div
            style="
              width: 214px;
          ...
          >
            ...
            <div>
              <span>打印模板：</span>
              <el-button plain>110X90mm纸</el-button>
              <el-button plain>默认使用模板设置的打印机</el-button>
            </div>
            <div>
              <span>打印数量：</span>
              <el-button plain>100</el-button>
              <el-button plain>打印预览</el-button>
              <el-button plain>立即打印</el-button>
            </div>
          </div>
        </div>
      </el-tab-pane>
