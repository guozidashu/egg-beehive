      ...
      <el-tab-pane label="常规打印" name="first">
        ...
        >
          ...
          <div>
            <span>尺码：</span>
            <span>
              <el-button plain type="warning">80</el-button>
              <el-button plain type="warning">90</el-button>
              <el-button plain type="warning">100</el-button>
              <el-button plain type="warning">110</el-button>
              <el-button plain type="warning">120</el-button>
            </span>
          </div>
        </div>
      </el-tab-pane>
