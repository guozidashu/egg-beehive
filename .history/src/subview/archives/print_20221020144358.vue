      ...
      <el-tab-pane label="常规打印" name="first">
        ...
        >
          ...
          <div>
            <span>尺码：</span>
            <span>
              <el-button style="color: #000" type="text">80</el-button>
              <el-button style="color: #000" type="text">90</el-button>
              <el-button style="color: #000" type="text">100</el-button>
              <el-button style="color: #000" type="text">120</el-button>
            </span>
          </div>
        </div>
      </el-tab-pane>
