<template>
  <div style="background-color: #f6f8f9">
    <el-card
      :body-style="{ padding: '25px 0 0 25px' }"
      class="card-ra"
      shadow="never"
    >
      <div slot="header">
      ...
      <div style="display: flex; flex-wrap: wrap">
        <div v-for="o in 11" :key="o" style="width: 25%; padding-bottom: 25px">
          <vab-icon icon="account-circle-fill" />
          商城名称：商城系统
        </div>
      </div>
    </el-card>
    <div style="display: flex; justify-content: space-between">
      ...
      <el-card
        class="card-ra"
        shadow="never"
        style="width: 26%; min-height: calc(56vh)"
      >
        <div slot="header">
          <span>客服信息</span>
        </div>
          ...
          <div style="display: flex">
            ...
            <div>
              ...
              <p>
                ...
                <!-- <el-tooltip content="Top center" placement="top">
                  <span style="padding: 0; color: #1890ff; border: 0">
                    点击查看
                  </span>
                </el-tooltip> -->
