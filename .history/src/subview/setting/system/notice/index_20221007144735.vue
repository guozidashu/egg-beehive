  ...
  <div class="comprehensive-form-container">
    <el-card class="tabs-card" shadow="hover">
      <el-tabs v-model="activeName">
        <el-tab-pane label="短信" name="first">敬请期待</el-tab-pane>
        <el-tab-pane label="微信模板" name="second">敬请期待</el-tab-pane>
        <el-tab-pane label="企业微信模板" name="first">敬请期待</el-tab-pane>
        <el-tab-pane label="小程序通知模板" name="second">敬请期待</el-tab-pane>
      </el-tabs>
    </el-card>
