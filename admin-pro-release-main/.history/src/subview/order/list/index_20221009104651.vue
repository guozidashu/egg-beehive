  ...
  <div class="comprehensive-form-container">
    <el-card shadow="never">
      ...
      >
        <!-- 表单组件具名插槽自定义表单 -->
        <template #Form>
          <el-form-item class="f-w-600" label="订单状态:">
            <el-radio-group
          ...
          <el-form-item class="f-w-600" label="支付来源:">
            <el-radio-group
          ...
          <el-form-item v-show="!orderForm.fold" label-width="0px">
            <el-select
          ...
          <!-- <el-form-item v-show="!orderForm.fold" label-width="10px" /> -->
      ...
      <el-tabs v-model="activeName" class="table-pos" @tab-click="handleClick">
        ...
        <el-tab-pane label="普通订单" name="second">敬请期待</el-tab-pane>
        <el-tab-pane label=" 商城订单" name="three">敬请期待</el-tab-pane>
        <el-tab-pane label="第三方订单" name="four">敬请期待</el-tab-pane>
      </el-tabs>
    </el-card>
  </div>
</template>
