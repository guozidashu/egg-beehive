        ...
        <template #Form>
          <el-col :span="9" style="margin-top: 10px">
            <el-form-item label="订单状态:" style="font-weight: 600">
              <el-radio-group v-model="orderForm.orderSta" size="mini">
          ...
          <el-col :span="9" style="margin-top: 10px">
            <el-form-item label="支付来源:" style="font-weight: 600">
              <el-radio-group v-model="orderForm.paySta" size="mini">
                <el-radio-button label="全部" />
          ...
          <el-col v-show="!orderForm.fold" :span="24" style="margin-top: 10px">
            <el-form-item label="订单来源:" style="font-weight: 600">
              <el-radio-group v-model="orderForm.orderSource" size="mini">
          ...
          <el-col v-show="!orderForm.fold" :span="5" style="margin-top: 10px">
            ...
            >
              ...
              <el-option label="会员信息" value="order" />
              <el-option label="收货信息" value="huiyuan" />
              <el-option label="快递单号" value="order" />
              <el-option label="商品Id" value="huiyuan" />
              <el-option label="商品名称" value="order" />
              <el-option label="商品编码" value="huiyuan" />
              <el-option label="核销员" value="huiyuan" />
              <el-option label="所属门店" value="huiyuan" />
            </el-select>
            <el-input
