    ...
    children: [
      {
        path: 'wxpublic',
        name: 'Wxpublic',
        component: () => import('@/subview/platform/wxpublic/index'),
        meta: {
          title: '微信公众号',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'wxprogram',
        name: 'Wxprogram',
        // component: () => import('@/subview/platform/wxprogram/index'),
        meta: {
          title: '微信小程序',
          // icon: 'home-2-line',
        },
        children: [
          {
            path: 'wxprogram/binding',
            name: 'WxprogrambBinding',
            component: () =>
              import('@/subview/platform/wxprogram/binding/index'),
            meta: {
              title: '统计',
              // icon: 'home-2-line',
            },
          },
          {
            path: 'wxprogram/pay',
            name: 'WxprogramPay',
            component: () => import('@/subview/platform/wxprogram/pay/index'),
            meta: {
              title: '统计',
              // icon: 'home-2-line',
            },
