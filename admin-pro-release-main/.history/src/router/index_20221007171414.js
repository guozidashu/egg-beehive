  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'bdbprogram',
        name: 'Bdprogram',
        component: () => import('@/subview/platform/bdbprogram/index'),
        meta: {
          title: '百度小程序',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'ttbprogram',
        name: 'Ttprogram',
        component: () => import('@/subview/platform/ttbprogram/index'),
        meta: {
          title: '头条小程序',
          // icon: 'home-2-line',
        },
      },
      {
        path: 'qqbprogram',
        name: 'Qqprogram',
        component: () => import('@/subview/platform/qqbprogram/index'),
        meta: {
          title: 'QQ小程序',
          // icon: 'home-2-line',
        },
